...
```text
Sigue la sección Codex de docs/bootstrap-v6.md para instalar Harness Engineering V6 en este repo.
...
```text
Sigue la sección OpenCode de docs/bootstrap-v6.md para instalar Harness Engineering V6 en este repo.
...
```text
Sigue la sección Antigravity de docs/bootstrap-v6.md para instalar Harness Engineering V6 en este repo.
Mismos 6 pasos con --agent antigravity. Solo-agente inline + Mission Control; espejo en .gemini/skills/ (+ .codex/skills/ para Codex). Si tu versión solo lee skills globales, declara el límite y documenta la instalación manual sin escribir en ~. Re-exporta AGENTS.md en GEMINI.md.
```
