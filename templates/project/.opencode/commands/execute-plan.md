...
La referencia debe ser una ruta como `.opencode/plans/2026-08-11-hardening-sync-continuidad-series.md`. Si no se proporciona una ruta exacta, inspecciona `.opencode/plans/` priorizando planes con estado `pendiente` o `en progreso` y solicita aclaración si existe más de un plan plausible.
