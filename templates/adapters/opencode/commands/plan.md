...
Cuando la ambigüedad lo justifique, agrega secciones SDD-lite `## Propuesta`, `## Spec` y `## Tareas`. No añadas la sección de historial: la agrega el Executor al concluir el plan.

Edita únicamente el archivo del plan dentro de `.harness/plans/`. No edites el código ni crees commits. No fijes proveedor ni modelo.
